...
@section('title', __('admin.create') . ' ' . __('admin.posts'))
@section('header', __('admin.create') . ' ' . __('admin.posts'))
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="{{ __('admin.auto_generate') }}"
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800">
                ...
                <textarea name="excerpt" id="excerpt" rows="3" 
                          class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-violet-500 focus:border-transparent">{{ old('excerpt') }}</textarea>
            </div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-800 space-y-4">
                <div>
                    ...
                    <select name="status" id="status" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900">
                        ...
                        <option value="scheduled" {{ old('status') === 'scheduled' ? 'selected' : '' }}>{{ __('admin.scheduled') }}</option>
                    </select>
                </div>
                <div>
