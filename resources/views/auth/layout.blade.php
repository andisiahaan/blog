        ...
        <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
                <div class="max-w-md text-center">
                    <h1 class="text-4xl font-bold mb-6">{{ config('app.name', 'Blog') }}</h1>
                    <p class="text-lg text-white/80 mb-8">{{ __('common.welcome_message', ['name' => config('app.name', 'Blog')]) }}</p>
                    <div class="flex items-center justify-center space-x-1 text-sm text-white/60">
                        <span class="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
                        <span>{{ __('common.secure_connection') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center p-6 md:p-12">
            <div class="w-full max-w-md">
                ...
                <div class="md:hidden text-center mb-8">
                    <h1 class="text-2xl font-bold text-violet-600 dark:text-violet-400">{{ config('app.name', 'Blog') }}</h1>
                </div>
